...
%        at the nodes
%  x column vector of interpolated points.
% p - interpolated data at x 
%  original definition was wrong !!  Column one is just the 
...
xdist=reshape(repmat(x,1,M), [N,M])-repmat(data(:,1).',N,1);
